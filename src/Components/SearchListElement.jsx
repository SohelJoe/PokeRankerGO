...
const SearchListElement = ({ data, onClick }) => {
    const [name, id, form, type1, type2] = data;

    return <li className='flex relative first:mt-2 items-center gap-2 text-xl font-semibold hover:bg-sky-400/10 hover:text-sky-900 dark:hover:text-sky-100 py-2 px-4 rounded-lg' onClick={() => onClick(data)}>
