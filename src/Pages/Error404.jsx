    ...
    return (
        <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
                <button type="link" className="cursor-pointer rounded-md bg-sky-700 dark:bg-sky-600/80 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-sky-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600" onClick={() => changePage('ranking')}>Go back home</button>
            </div>
        </div>
    )
}
