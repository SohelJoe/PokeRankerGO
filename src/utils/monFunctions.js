...
export const getMonData = (monKey, isBestBuddy) => {
    ...
    family.forEach((id) => {
        tempMonFamily[id] = pokeListDB[id];
    })
    ...
    return {
        ...
        pvpRankings: familyRankingByMon,
        selectedMon: [monKey, name, id, form, type1, type2, bNumAtt, bNumDef, bNumHp, ...family]
    }
}
...
export const calculateAllRanks = (baseatk, basedef, basesta, floor, minLvl, maxLvl, invalid, league) => {
...
export const getMonName = (monKey) => {
    return pokeListDB[monKey] ? pokeListDB[monKey][0] : 'Unknown';
}

export const calculateCP = (attack, defense, hp, level) => {
